...
class CPU() {
  ...
  private val prefixOpcodes: Map<Int, Function<Unit>> = mapOf(
    ...
    0x34 to { H = swap(H) },
    0x35 to { L = swap(L) },
    0x36 to { ram.setByteAt(HL, swap(ram.getByteAt(HL))) },
    0x37 to { A = swap(A) },
    0x38 to { B = srl(B) },
    0x39 to { C = srl(C) },
    0x3a to { D = srl(D) },
    ...
    0x3c to { H = srl(H) },
    0x3d to { L = srl(L) },
    0x3e to { ram.setByteAt(HL, srl(ram.getByteAt(HL))) },
    0x3f to { A = srl(A) },
    0x40 to { setZero(BIT(B, 0)) },
    0x41 to { setZero(BIT(C, 0)) },
    0x42 to { setZero(BIT(D, 0)) },
    0x43 to { setZero(BIT(E, 0)) },
    0x44 to { setZero(BIT(H, 0)) },
    0x45 to { setZero(BIT(L, 0)) },
    0x46 to { setZero(BIT(ram.getByteAt(HL), 0)) },
    0x47 to { setZero(BIT(A, 0)) },
    0x48 to { setZero(BIT(B, 1)) },
    0x49 to { setZero(BIT(B, 1)) },
    0x4a to { setZero(BIT(B, 1)) },
    0x4b to { setZero(BIT(B, 1)) },
    0x4c to { setZero(BIT(B, 1)) },
    0x4d to { setZero(BIT(B, 1)) },
    0x4e to { setZero(BIT(ram.getByteAt(HL), 1)) },
    0x4f to { setZero(BIT(A, 1)) },
    0x50 to { setZero(BIT(B, 2)) },
    0x51 to { setZero(BIT(C, 2)) },
    0x52 to { setZero(BIT(D, 2)) },
    0x53 to { setZero(BIT(E, 2)) },
    0x54 to { setZero(BIT(H, 2)) },
    0x55 to { setZero(BIT(L, 2)) },
    0x56 to { setZero(BIT(ram.getByteAt(HL), 2)) },
    0x57 to { setZero(BIT(A, 2)) },
    0x58 to { setZero(BIT(B, 3)) },
    0x59 to { setZero(BIT(B, 3)) },
    0x5a to { setZero(BIT(B, 3)) },
    0x5b to { setZero(BIT(B, 3)) },
    0x5c to { setZero(BIT(B, 3)) },
    0x5d to { setZero(BIT(B, 3)) },
    0x5e to { setZero(BIT(ram.getByteAt(HL), 3)) },
    0x5f to { setZero(BIT(A, 3)) },
    0x60 to { setZero(BIT(B, 4)) },
    0x61 to { setZero(BIT(C, 4)) },
    0x62 to { setZero(BIT(D, 4)) },
    0x63 to { setZero(BIT(E, 4)) },
    0x64 to { setZero(BIT(H, 4)) },
    0x65 to { setZero(BIT(L, 4)) },
    0x66 to { setZero(BIT(ram.getByteAt(HL), 4)) },
    0x67 to { setZero(BIT(A, 4)) },
    0x68 to { setZero(BIT(B, 5)) },
    0x69 to { setZero(BIT(B, 5)) },
    0x6a to { setZero(BIT(B, 5)) },
    0x6b to { setZero(BIT(B, 5)) },
    0x6c to { setZero(BIT(B, 5)) },
    0x6d to { setZero(BIT(B, 5)) },
    0x6e to { setZero(BIT(ram.getByteAt(HL), 5)) },
    0x6f to { setZero(BIT(A, 5)) },
    0x70 to { setZero(BIT(B, 6)) },
    0x71 to { setZero(BIT(C, 6)) },
    0x72 to { setZero(BIT(D, 6)) },
    0x73 to { setZero(BIT(E, 6)) },
    0x74 to { setZero(BIT(H, 6)) },
    0x75 to { setZero(BIT(L, 6)) },
    0x76 to { setZero(BIT(ram.getByteAt(HL), 6)) },
    0x77 to { setZero(BIT(A, 6)) },
    0x78 to { setZero(BIT(B, 7)) },
    0x79 to { setZero(BIT(B, 7)) },
    0x7a to { setZero(BIT(B, 7)) },
    0x7b to { setZero(BIT(B, 7)) },
    0x7c to { setZero(BIT(B, 7)) },
    0x7d to { setZero(BIT(B, 7)) },
    0x7e to { setZero(BIT(ram.getByteAt(HL), 7)) },
    0x7f to { setZero(BIT(A, 7)) },
    0x80 to { B = RES(B, 0) },
    0x81 to { C = RES(C, 0) },
    0x82 to { D = RES(D, 0) },
    0x83 to { E = RES(E, 0) },
    0x84 to { H = RES(H, 0) },
    0x85 to { L = RES(L, 0) },
    0x86 to { ram.setByteAt(HL, RES(ram.getByteAt(HL), 0)) },
    0x87 to { A = RES(A, 0) },
    0x88 to { B = RES(B, 1) },
    0x89 to { C = RES(B, 1) },
    0x8a to { D = RES(B, 1) },
    ...
    0x8c to { H = RES(B, 1) },
    0x8d to { L = RES(B, 1) },
    0x8e to { ram.setByteAt(HL, RES(ram.getByteAt(HL), 1)) },
    0x8f to { A = RES(A, 1) },
    0x90 to { B = RES(B, 2) },
    0x91 to { C = RES(C, 2) },
    0x92 to { D = RES(D, 2) },
    ...
    0x94 to { H = RES(H, 2) },
    0x95 to { L = RES(L, 2) },
    0x96 to { ram.setByteAt(HL, RES(ram.getByteAt(HL), 2)) },
    0x97 to { A = RES(A, 2) },
    0x98 to { B = RES(B, 3) },
    0x99 to { C = RES(B, 3) },
    0x9a to { D = RES(B, 3) },
    ...
    0x9c to { H = RES(B, 3) },
    0x9d to { L = RES(B, 3) },
    0x9e to { ram.setByteAt(HL, RES(ram.getByteAt(HL), 3)) },
    0x9f to { A = RES(A, 3) },
    0xa0 to { B = RES(B, 4) },
    0xa1 to { C = RES(C, 4) },
    0xa2 to { D = RES(D, 4) },
    ...
    0xa4 to { H = RES(H, 4) },
    0xa5 to { L = RES(L, 4) },
    0xa6 to { ram.setByteAt(HL, RES(ram.getByteAt(HL), 4)) },
    0xa7 to { A = RES(A, 4) },
    0xa8 to { B = RES(B, 5) },
    0xa9 to { C = RES(B, 5) },
    0xaa to { D = RES(B, 5) },
    ...
    0xac to { H = RES(B, 5) },
    0xad to { L = RES(B, 5) },
    0xae to { ram.setByteAt(HL, RES(ram.getByteAt(HL), 5)) },
    0xaf to { A = RES(A, 5) },
    0xb0 to { B = RES(B, 6) },
    0xb1 to { C = RES(C, 6) },
    0xb2 to { D = RES(D, 6) },
    ...
    0xb4 to { H = RES(H, 6) },
    0xb5 to { L = RES(L, 6) },
    0xb6 to { ram.setByteAt(HL, RES(ram.getByteAt(HL), 6)) },
    0xb7 to { A = RES(A, 6) },
    0xb8 to { B = RES(B, 7) },
    0xb9 to { C = RES(B, 7) },
    0xba to { D = RES(B, 7) },
    ...
    0xbc to { H = RES(B, 7) },
    0xbd to { L = RES(B, 7) },
    0xbe to { ram.setByteAt(HL, RES(ram.getByteAt(HL), 7)) },
    0xbf to { A = RES(A, 7) },
    0xc0 to { B = SET(B, 0) },
    0xc1 to { C = SET(C, 0) },
    0xc2 to { D = SET(D, 0) },
    ...
    0xc4 to { H = SET(H, 0) },
    0xc5 to { L = SET(L, 0) },
    0xc6 to { ram.setByteAt(HL, SET(ram.getByteAt(HL), 0)) },
    0xc7 to { A = SET(A, 0) },
    0xc8 to { B = SET(B, 1) },
    0xc9 to { C = SET(B, 1) },
    0xca to { D = SET(B, 1) },
    ...
    0xcc to { H = SET(B, 1) },
    0xcd to { L = SET(B, 1) },
    0xce to { ram.setByteAt(HL, SET(ram.getByteAt(HL), 1)) },
    0xcf to { A = SET(A, 1) },
    0xd0 to { B = SET(B, 2) },
    0xd1 to { C = SET(C, 2) },
    0xd2 to { D = SET(D, 2) },
    ...
    0xd4 to { H = SET(H, 2) },
    0xd5 to { L = SET(L, 2) },
    0xd6 to { ram.setByteAt(HL, SET(ram.getByteAt(HL), 2)) },
    0xd7 to { A = SET(A, 2) },
    0xd8 to { B = SET(B, 3) },
    0xd9 to { C = SET(B, 3) },
    0xda to { D = SET(B, 3) },
    ...
    0xdc to { H = SET(B, 3) },
    0xdd to { L = SET(B, 3) },
    0xde to { ram.setByteAt(HL, SET(ram.getByteAt(HL), 3)) },
    0xdf to { A = SET(A, 3) },
    0xe0 to { B = SET(B, 4) },
    0xe1 to { C = SET(C, 4) },
    0xe2 to { D = SET(D, 4) },
    ...
    0xe4 to { H = SET(H, 4) },
    0xe5 to { L = SET(L, 4) },
    0xe6 to { ram.setByteAt(HL, SET(ram.getByteAt(HL), 4)) },
    0xe7 to { A = SET(A, 4) },
    0xe8 to { B = SET(B, 5) },
    0xe9 to { C = SET(B, 5) },
    0xea to { D = SET(B, 5) },
    ...
    0xec to { H = SET(B, 5) },
    0xed to { L = SET(B, 5) },
    0xee to { ram.setByteAt(HL, SET(ram.getByteAt(HL), 5)) },
    0xef to { A = SET(A, 5) },
    0xf0 to { B = SET(B, 6) },
    0xf1 to { C = SET(C, 6) },
    0xf2 to { D = SET(D, 6) },
    ...
    0xf4 to { H = SET(H, 6) },
    0xf5 to { L = SET(L, 6) },
    0xf6 to { ram.setByteAt(HL, SET(ram.getByteAt(HL), 6)) },
    0xf7 to { A = SET(A, 6) },
    0xf8 to { B = SET(B, 7) },
    0xf9 to { C = SET(B, 7) },
    0xfa to { D = SET(B, 7) },
    ...
    0xfc to { H = SET(B, 7) },
    0xfd to { L = SET(B, 7) },
    0xfe to { ram.setByteAt(HL, SET(ram.getByteAt(HL), 7)) },
    0xff to { A = SET(A, 7) }
  )
  fun tick() {
  }
